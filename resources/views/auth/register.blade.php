                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <?php
                            $num1 = rand(1,10);
                            $num2 = rand(1,10);
                            session(['math_sum' => $num1 + $num2]);
                        ?>

                        <div class="row mb-3">
                            <label class="col-md-4 col-form-label text-md-end">{{ $num1 }} + {{ $num2 }} = ?</label>
                            <div class="col-md-6">
                                <input id="math_answer" type="text" class="form-control @error('math_answer') is-invalid @enderror" 
                                       name="math_answer" required>
                                @error('math_answer')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
